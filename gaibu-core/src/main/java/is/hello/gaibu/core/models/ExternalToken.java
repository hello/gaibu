...
public class ExternalToken implements Principal {
    ...
    public ExternalToken(
        ...
        Preconditions.checkNotNull(accessExpiresIn, "accessExpiresIn can not be null");
        Preconditions.checkNotNull(createdAt, "createdAt can not be null");
        Preconditions.checkNotNull(deviceId, "deviceId can not be null");
